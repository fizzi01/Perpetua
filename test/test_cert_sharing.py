...
class TestCertificateSharing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cert_manager.generate_server_certificate(ip_addresses=["127.0.0.1"], hostname="test.local")
    ...
    def test_jwt_creation_and_decryption(self):
        ...
        cert_str = self.cert_data.decode('utf-8') if isinstance(self.cert_data, bytes) else self.cert_data
