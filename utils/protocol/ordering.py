...
class OrderedMessageProcessor:
    ...
    def __init__(self, process_callback: Callable[[ProtocolMessage], None],
        ...
        self.ordered_queue = OrderedMessageQueue(max_delay_tolerance)
    ...
    def add_message(self, message: ProtocolMessage):
        ...
        self.ordered_queue.put(message)
    ...
    def _process_messages(self):
        ...
        while not self._stop_event.is_set():
            try:
                ...
                ready_messages = self.ordered_queue.get_ready_messages()
                ...
                if current_time - last_flush_time > flush_interval:
                    old_messages = self.ordered_queue.force_flush_old_messages()
