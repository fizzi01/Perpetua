...
class IMessageService(Thread):
    def send_mouse(self, screen: str | None, message: IBaseCommand) -> None:
        ...

    def send_keyboard(self, screen: str | None, message: IBaseCommand) -> None:
        ...

    def send_clipboard(self, screen: str | None, message: IBaseCommand) -> None:
        ...

    def send_screen_notification(self, screen: str | None, message: IBaseCommand) -> None:
        ...

    def send_file_request(self, screen: str | None, message: IBaseCommand) -> None:
        ...

    def send_file_copy(self, screen: str | None, message: IBaseCommand) -> None:
        ...
